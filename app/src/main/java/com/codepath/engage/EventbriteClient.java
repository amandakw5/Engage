...
public class EventbriteClient {
    ...
    private static final String baseApiUrl = "https://www.eventbriteapi.com/v3/";
    //Endpoint for seraching with a string input
    private static final String searchBaseUrl="events/search/?q=";
    private static final String eventFindUrl = "events/";
    private static final String venueUrl = "venues/";
    private static final String organizerUrl = "organizers/";
    private static final String endBaseUrl = "&token=ZVEFG6DHKZONNTXLL5HM";
    private static final String endVenueUrl = "/?token=ZVEFG6DHKZONNTXLL5HM";
    private static final String endOrganizerUrl = "/?token=ZVEFG6DHKZONNTXLL5HM";
